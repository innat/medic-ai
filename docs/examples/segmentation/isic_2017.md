...
```{note}
This example uses Tesla T4 GPUs available in the Kaggle environment. You can also run this code example directly on Kaggle; [gpu-notebook](https://www.kaggle.com/code/ipythonx/medicai-x-isic-2017-starter-x-binary-segmentation).
...
from medicai.transforms import (
    RandomFlip, RandomRotate90, RandomRotate, RandomElasticTransform, Compose
)
