...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **44.83** | -- | 8.68 | **3.50** | **20.86** | -- |
| DHWC | (1, 160, 160, 160, 1) | **61.85** | -- | 22.45 | **8.17** | **33.40** | -- |
| DHWC | (1, 256, 256, 256, 1) | **179.14** | -- | 183.30 | **30.41** | **227.23** | -- |

#### GPU

| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **76.40** | -- | 6.64 | **4.26** | **41.84** | -- |
| DHWC | (1, 160, 160, 160, 1) | **92.45** | -- | 7.97 | **5.39** | **44.38** | -- |
| DHWC | (1, 256, 256, 256, 1) | **161.12** | -- | **17.71** | 20.19 | **57.31** | -- |
### Orientation
...
| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **17.57** | -- | **2.73** | -- | 12.54 | -- |
| DHWC | (1, 160, 160, 160, 1) | **38.72** | -- | **8.40** | -- | **40.33** | -- |
| DHWC | (1, 256, 256, 256, 1) | **253.27** | -- | **51.87** | -- | **277.99** | -- |

#### GPU

| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **28.83** | -- | **5.99** | -- | 32.41 | -- |
| DHWC | (1, 160, 160, 160, 1) | **38.59** | -- | **15.96** | -- | **44.85** | -- |
| DHWC | (1, 256, 256, 256, 1) | **200.41** | -- | **164.22** | -- | **138.30** | -- |
### Resize
...
| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **12.04** | -- | **6.70** | 9.84 | **136.61** | -- |
| DHWC | (1, 160, 160, 160, 1) | **18.97** | -- | **29.77** | 44.08 | **154.51** | -- |
| DHWC | (1, 256, 256, 256, 1) | **73.06** | -- | **161.21** | 200.28 | **285.10** | -- |
| BHWC | (4, 224, 224, 1) | **9.34** | -- | 2.01 | **1.87** | **100.52** | -- |

#### GPU

| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **18.60** | -- | 5.88 | **4.55** | 285.90 | -- |
| DHWC | (1, 160, 160, 160, 1) | **27.06** | -- | 16.26 | **15.76** | **345.72** | -- |
| DHWC | (1, 256, 256, 256, 1) | **124.85** | -- | 164.33 | **163.49** | **383.45** | -- |
| BHWC | (4, 224, 224, 1) | **15.92** | -- | 3.32 | **2.53** | **204.47** | -- |
### SpatialCrop
...
| BHWC | (4, 1024, 1024, 1) | -- | -- | -- | -- | -- | -- |
| BDHWC | (1, 96, 96, 96, 1) | -- | -- | -- | -- | -- | -- |
| BDHWC | (1, 160, 160, 160, 1) | -- | -- | -- | -- | -- | -- |
| BDHWC | (1, 256, 256, 256, 1) | -- | -- | -- | -- | -- | -- |
...
| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| BHWC | (4, 224, 224, 1) | **11.22** | -- | 12.03 | **3.16** | 45.73 | **1.36** |
| BHWC | (8, 224, 224, 1) | **11.78** | -- | 21.16 | **4.20** | 45.62 | **1.94** |
| BHWC | (16, 224, 224, 1) | **12.67** | -- | 40.15 | **6.37** | 47.43 | **3.25** |
| BHWC | (32, 224, 224, 1) | **14.54** | -- | 77.39 | **10.25** | 49.77 | **5.52** |
| BHWC | (4, 512, 512, 1) | **14.12** | -- | 14.34 | **7.50** | 46.75 | **4.00** |
| BHWC | (8, 512, 512, 1) | **17.22** | -- | 25.61 | **12.74** | 52.02 | **10.75** |
| BHWC | (16, 512, 512, 1) | **34.08** | -- | 49.60 | **25.42** | 70.42 | **28.30** |
| BHWC | (4, 1024, 1024, 1) | **23.93** | -- | 50.76 | **26.25** | 71.66 | **28.09** |
| BHWC | (8, 1024, 1024, 1) | **93.39** | -- | 152.80 | **109.62** | 105.70 | **64.19** |
| BDHWC | (1, 96, 96, 96, 1) | 18.15 | **4.16** | 12.58 | **7.27** | 50.33 | **3.70** |
| BDHWC | (1, 160, 160, 160, 1) | 31.04 | **17.79** | 49.92 | **21.25** | 62.03 | **20.74** |
| BDHWC | (1, 256, 256, 256, 1) | **181.51** | 183.79 | 303.83 | **207.49** | 170.01 | **134.31** |
### RandomRotate90
...
| Layout | Shape | TensorFlow (ms) | TensorFlow-XLA (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-XLA (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| BHWC | (4, 224, 224, 1) | **19.52** | -- | 41.04 | **7.76** | 41.96 | **4.14** |
| BHWC | (8, 224, 224, 1) | **23.78** | -- | 74.29 | **16.32** | 50.80 | **8.21** |
| BHWC | (16, 224, 224, 1) | **32.59** | -- | 140.00 | **26.41** | 78.10 | **16.37** |
| BHWC | (32, 224, 224, 1) | **52.22** | -- | 260.15 | **55.10** | 109.51 | **45.80** |
| BHWC | (4, 512, 512, 1) | **39.74** | -- | 146.75 | **30.78** | 77.67 | **21.87** |
| BHWC | (8, 512, 512, 1) | **62.96** | -- | 279.72 | **67.03** | 176.50 | **60.29** |
| BHWC | (16, 512, 512, 1) | **112.92** | -- | 607.86 | **191.56** | 416.54 | **114.15** |
| BHWC | (4, 1024, 1024, 1) | **116.67** | -- | 565.22 | **195.07** | 444.04 | **114.33** |
| BDHWC | (1, 96, 96, 96, 1) | 433.29 | **43.86** | 232.62 | **48.21** | 242.79 | **44.52** |
| BDHWC | (1, 160, 160, 160, 1) | 1287.54 | **247.75** | 1022.99 | **279.91** | 1963.74 | **256.50** |
| BDHWC | (1, 256, 256, 256, 1) | 12438.24 | **855.33** | 12278.13 | **1242.49** | 13205.06 | **1097.77** |

#### GPU

| Layout | Shape | TensorFlow (ms) | TensorFlow-XLA (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-XLA (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| BHWC | (4, 224, 224, 1) | **16.02** | -- | **13.14** | -- | **53.33** | -- |
| BHWC | (8, 224, 224, 1) | **16.72** | -- | **22.31** | -- | **51.84** | -- |
| BHWC | (16, 224, 224, 1) | **17.63** | -- | **45.95** | -- | **55.22** | -- |
| BHWC | (32, 224, 224, 1) | **20.44** | -- | **76.88** | -- | **57.23** | -- |
| BHWC | (4, 512, 512, 1) | **18.10** | -- | **14.98** | -- | **56.04** | -- |
| BHWC | (8, 512, 512, 1) | **21.65** | -- | **27.87** | -- | **59.79** | -- |
| BHWC | (16, 512, 512, 1) | **50.91** | -- | **82.16** | -- | **78.66** | -- |
| BHWC | (4, 1024, 1024, 1) | **29.10** | -- | **61.69** | -- | **79.13** | -- |
| BHWC | (8, 1024, 1024, 1) | **96.78** | -- | **155.74** | -- | **114.22** | -- |
| BDHWC | (1, 96, 96, 96, 1) | **167.90** | -- | **20.42** | -- | **108.01** | -- |
| BDHWC | (1, 160, 160, 160, 1) | **447.33** | -- | **79.28** | -- | **117.01** | -- |
| BDHWC | (1, 256, 256, 256, 1) | **4198.42** | -- | **416.17** | -- | **345.10** | -- |
...
| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **44.66** | -- | **14.64** | 24.67 | 22.52 | **12.39** |
| DHWC | (1, 160, 160, 160, 1) | **129.92** | -- | **59.99** | 87.94 | 82.81 | **75.34** |
| DHWC | (1, 256, 256, 256, 1) | **676.77** | -- | **459.45** | 493.98 | 562.83 | **345.11** |
| BHWC | (4, 224, 224, 1) | **20.21** | -- | **3.79** | 4.97 | 11.43 | **1.07** |

#### GPU

| Layout | Shape | TF (ms) | TF-xla (ms) | Torch (ms) | Torch-compiled (ms) | JAX (ms) | JAX-xla (ms) |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| DHWC | (1, 96, 96, 96, 1) | **57.72** | -- | **7.90** | -- | 37.72 | **1.98** |
| DHWC | (1, 160, 160, 160, 1) | **134.19** | -- | **15.95** | -- | 47.07 | **10.81** |
| DHWC | (1, 256, 256, 256, 1) | **670.65** | -- | **124.05** | -- | 112.13 | **75.26** |
| BHWC | (4, 224, 224, 1) | **35.49** | -- | **5.73** | -- | 32.94 | **0.72** |
