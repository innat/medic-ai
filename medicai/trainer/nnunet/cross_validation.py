"""
medicai/trainer/nnunet/cross_validation.py
==================================
5-fold cross-validation helpers.

Provides:
  - generate_splits        : stratified k-fold split with fixed seed
  - save_splits / load_splits
  - aggregate_fold_results : summarise per-fold Dice scores
"""
