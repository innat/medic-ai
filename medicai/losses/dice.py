...
SparseDiceLoss.__doc__ = SPARSE_LOSS_DOCSTRING.format(name="sparse_dice_loss")

BINARY_LOSS_DOCSTRING = (
    """Dice loss for binary or multi-label segmentation tasks.
...
BinaryDiceLoss.__doc__ = BINARY_LOSS_DOCSTRING.format(name="binary_dice_loss")
