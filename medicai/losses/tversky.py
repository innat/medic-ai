...
class SparseTverskyLoss(BaseTverskyLoss, DescribeMixin):
    """Tversky loss for sparse categorical segmentation labels.
    ...
    Args:
        ...
        reduction (str, optional): Type of reduction to apply to the loss.
            ...
            * **'none'**: Return the loss tensor without aggregation, preserving the
            ...
            Defaults to 'mean'.
        name (str, optional): Name of the loss function. Defaults to "sparse_tversky_loss".
...
class CategoricalTverskyLoss(BaseTverskyLoss, DescribeMixin):
    """Tversky loss for categorical (one-hot encoded) segmentation labels.
    ...
    Args:
        ...
        reduction (str, optional): Type of reduction to apply to the loss.
            ...
            * **'none'**: Return the loss tensor without aggregation, preserving the
            ...
            Defaults to 'mean'.
        name (str, optional): Name of the loss function. Defaults to "categorical_tversky_loss".
        **kwargs: Additional keyword arguments passed to `keras.losses.Loss`.
    """
...
class BinaryTverskyLoss(BaseTverskyLoss, DescribeMixin):
    """Tversky loss for binary segmentation tasks.
