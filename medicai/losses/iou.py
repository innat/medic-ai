...
class SparseIoULoss(BaseIoULoss, DescribeMixin):
    """IoU/Jaccard loss for sparse categorical segmentation labels.
    ...
    the IoU coefficient. It uses a **Softmax** activation on logits.
    ...
    Args:
        ...
        reduction (str, optional): Type of reduction to apply to the loss.
            ...
            * **'none'**: Return the loss tensor without aggregation, preserving the
            ...
            Defaults to 'mean'.
        name (str, optional): Name of the loss function. Defaults to "sparse_iou_loss".
...
class CategoricalIoULoss(BaseIoULoss, DescribeMixin):
    """IoU/Jaccard loss for categorical (one-hot encoded) segmentation labels.

    This loss function calculates the IoU loss directly using the provided
    one-hot encoded labels and prediction probabilities. It uses a **Softmax** activation on logits.
    ...
    Args:
        ...
        reduction (str, optional): Type of reduction to apply to the loss.
            ...
            * **'none'**: Return the loss tensor without aggregation, preserving the
            ...
            Defaults to 'mean'.
        name (str, optional): Name of the loss function. Defaults to "categorical_iou_loss".
        **kwargs: Additional keyword arguments passed to `keras.losses.Loss`.
    """
...
class BinaryIoULoss(BaseIoULoss, DescribeMixin):
    """IoU loss for binary or multi-label segmentation tasks.
    ...
    Args:
        ...
        num_classes (int): Must be set to **1** for true binary segmentation,
            or **2** if the input/output explicitly contains two channels.
        class_ids (int, list of int, or None): If an integer or a list of integers,
            the IoU loss will be calculated only for the specified class(es).
        ...
        reduction (str, optional): Type of reduction to apply to the loss.
            ...
            * **'none'**: Return the loss tensor without aggregation, preserving the
            ...
            Defaults to 'mean'.
        name (str, optional): Name of the loss function. Defaults to "binary_iou_loss".
        **kwargs: Additional keyword arguments passed to `keras.losses.Loss`.
    """
