...
#     def update_seg_cfg(
#         self, model_name=None, backbone=None, input_size=None, num_classes=None, shuffle=False
#     ):
#         valid_values = {
#             "model_name": ["unet"],
...
#         params = {"model_name": model_name, "backbone": backbone}
#         for param_name, value in params.items():
#             self._validate_param(param_name, value, valid_values[param_name])
