...
def vswin_tiny(input_shape=(8, 224, 224, 1)):
    model = VideoSwinBackboneV2(
...
encoder = vswin_tiny(input_shape=(96, 96, 96, 1))
inputs = encoder.input

# Get the outputs of the Swin Transformer stages
skips = [
    encoder.get_layer("patching_and_embedding").output,  # hidden_states_out[0]
    encoder.get_layer("swin_feature1").output,  # hidden_states_out[1]
    encoder.get_layer("swin_feature2").output,  # hidden_states_out[2]
    encoder.get_layer("swin_feature3").output,  # hidden_states_out[3]
    encoder.get_layer("swin_feature4").output,  # hidden_states_out[4]
]
...
model_keras = Model(inputs, outputs)