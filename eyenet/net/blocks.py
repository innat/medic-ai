...
def FunctionalModel(input_shape):
    ...
    def apply(entity):
        ...
        channel_x = ChannelWiseAttention()(model_x.get_layer("block5a_expand_conv").output)
        ...
        feat_element_x = layers.Dense(num_of_class, activation="softmax", name="primary", dtype="float32")(feat_element_x)

        element_x = layers.Dense(num_of_class, activation="softmax", name="auxilary", dtype="float32")(element_x)
